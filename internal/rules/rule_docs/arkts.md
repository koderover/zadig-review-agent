...
- Spelling errors introduced at component, variable, or function declarations; confirm repository naming before reporting
...
- Prefer async/await; use `Promise.all` only when operations are independent and parallel execution does not violate ordering or resource limits
